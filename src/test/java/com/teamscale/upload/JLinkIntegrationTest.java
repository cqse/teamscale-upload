...
/**
 * Integration Tests. Runs the JLink-generated native distribution in different
 * scenarios.
 * <p>
 ...
 * "teamscale-upload-build-test-user" on
 * <a href="https://cqse.teamscale.io/">cqse.teamscale.io</a>. The user has
 * report-upload permission for project "teamscale-upload" and is used for
 * testing in the GitHub Project
 * <a href="https://github.com/cqse/teamscale-upload">teamscale upload</a>. The
...
public class JLinkIntegrationTest extends IntegrationTestBase {
	...
	/**
	 * Checks whether the executable exists and can be executed (i.e., whether the
	 * extraction step worked).
	 */
	private static void validateExecutable() {
		...
		if (!executable.canExecute()) {
			Assertions.fail("teamscale-upload script exists, but is not executable after extracting distribution. "
					+ executable.getPath());
		}
	}
