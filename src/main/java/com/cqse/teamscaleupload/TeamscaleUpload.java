...
public class TeamscaleUpload {
    ...
    private static Input parseArguments(String[] args) {
        ...
        parser.addArgument("--append-to-message").metavar("LINE").type(String.class)
                ...
                .help("Appends the given line to the message. Use this to augment the autogenerated message instead of replacing it. You may specify this parameter multiple times to append several lines to the message.");
