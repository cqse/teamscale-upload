 ...
 * report.
 * <p>
 * This class is a DTO used to serialize testwise coverage reports. Field names
 * and structure may not be changed.
 */
public class TestInfo {
	...
	/**
	 * Creates a {@link TestInfo} from the {@link ActionTest}. Returns
	 * {@link Optional#empty()} in case the {@link ActionTest} doesn't represent an
	 * actual test.
	 */
