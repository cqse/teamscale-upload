...
/**
 * Tries to detect a Git repository in the current directory and read its checked out commit.
 */
public class GitChecker {

    /**
     * If the current working directory is a valid git repository, returns its current commit SHA-1.
