...
/**
 * Tries to detect an SVN repository in the current directory and read its checked out revision.
 */
public class SvnChecker {

    /**
     * If the current working directory is an SVN checkout, returns the working directory's revision.
