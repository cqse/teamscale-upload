...
public class AntPatternUtils {
	...
	/**
	 * Normalizes the given pattern by ensuring forward slashes and mapping trailing
	 * slash to '/**'.
	 */
	...
	/**
	 * Converts a plain ANT pattern to a regular expression, by replacing special
	 * characters, such as '?', '*', and '**'. The created pattern is appended to
	 * the given {@link StringBuilder}. The pattern must be plain, i.e. all ANT
	 ...
	 * index. Appends the pattern fragment the the builder and returns the index to
	...
	/**
	 * Returns whether the given position exists in the string and equals the given
